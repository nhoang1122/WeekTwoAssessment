...
//CODE HERE
let empOne = new Employee('Jess', 'Weekend Mornings');
console.log(empOne);
...
class Manager extends Employee {
    ...
    addEmployee(empString){
        this.employees.push(empString);
    }
}
...
//CODE HERE
let manager = new Manager('Winston', 'Weekday Afternoons', ['CeCe', 'Schmidt']);
console.log(manager);
