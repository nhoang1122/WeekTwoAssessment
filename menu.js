...
//CODE HERE
let {category} = pizza;
console.log('Pizza Category: ', category);
...
// const filteredFood = foodArr.filter(element,index => element[index] === 'Kids')
// console.log(filteredFood)
// const filteredFood = foodArr.filter((element, index,key) => element[index]['key'] === 'Kids')
// console.log(filteredFood)
// const filterFood = foodArr.filter(function (element, key, tag){
